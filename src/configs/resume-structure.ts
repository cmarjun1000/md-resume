export default {
  ...
  projects: [
    ...
    },
    {
      ...
      location: 'Bengaluru, India',
      summary:
        'An internal web application that tracks sales, orders, and fulfilment. It includes product information, order details, order status, shipment status, product setup/installation status, the printing of shipment labels, bills, invoices, etc. From associating a shipment SKU to associating inventories to orders to shipping the orders and delivering it to the customers.'
    },
    {
